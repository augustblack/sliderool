...
const Modals = () => {
  ...
  return (
    <Template>
      ...
      <div className='bg-base-2 rounded p-4 space-y-2'>
        <div className='flex flex-row space-x-2'>
          <ButtonWithFocus open={showTwo} setOpen={setShowTwo} buttonProps={{ label: 'modal w/close full', kind: 'plain' }} />
          <ModalWithClose open={showTwo} setOpen={setShowTwo} full={true}>
